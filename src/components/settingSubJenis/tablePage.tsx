    ...
    <div className="rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          ...
          <tbody>
            {subjenisData.map((subjenisItem, index) => (
              <tr key={index}>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === subjenisData.length - 1 ? "border-b-0" : "border-b"}`}
                >
                ...
                >
                  <p
                    className={`inline-flex rounded-full px-3.5 py-1 text-body-sm font-medium ${
                      subjenisItem.levelId === 2
                        ? "bg-[#219653]/[0.08] text-[#219653]"
                        : subjenisItem.levelId === 1
                          ? "bg-[#D34053]/[0.08] text-[#D34053]"
                          : "bg-[#FFA70B]/[0.08] text-[#FFA70B]"
                    }`}
                  >
                    {subjenisItem.levelUser}
                  </p>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === subjenisData.length - 1 ? "border-b-0" : "border-b"}`}
                ...
                >
                  <p className="text-dark dark:text-white">
                    {subjenisItem.updatedDate}
                  </p>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7.5 ${index === subjenisData.length - 1 ? "border-b-0" : "border-b"}`}
                >
