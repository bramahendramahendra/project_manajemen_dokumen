...
const FormAddPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiRequest('/master_perihal/', 'POST', payload);
      ...
      if (response.ok) {
        ...
        setError(result.message || 'Terjadi kesalahan saat menambahkan perihal');
      }
    } catch (error) {
  ...
  return (
    <div className="rounded-[10px] bg-white px-7.5 pb-4 pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card">
      <h4 className="mb-5.5 font-medium text-dark dark:text-white">
        Untuk menambahkan Perihal, lakukan inputan data dengan benar dibawah ini
      </h4>
          ...
          <div className="p-6.5">
            ...
            <div className="mb-4.5">
              ...
              <input
                ...
                placeholder="Enter your perihal"
            ...
            {success && <p className="text-green-500 mt-2">Master perihal berhasil ditambahkan!</p>}  
          </div>
        </form>
      </div>
    </div>
