          ...
          <div className="relative w-full sm:w-80">
            <div className="relative">
              <input
                ...
                placeholder="Cari skpd, atau belum di validasi..."
                className="w-full pl-10 pr-9 py-2.5 text-[17px] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 transition-all duration-200"
              />
